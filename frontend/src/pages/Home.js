...
const BACKEND_URL = process.env.REACT_APP_BACKEND_URL || 'https://auction-wallet-fomo.preview.emergentagent.com';
...
function Home({ setCurrentPage }) {
  ...
  return (
    <div className="min-h-screen">
      <HeroSection setCurrentPage={setCurrentPage} strategyState={strategyState} />
