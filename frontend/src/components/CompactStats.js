            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip content="Strategy automatically buys NFTs at floor price when enough ETH accumulates from swap fees">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 relative" data-testid="token-burn-status">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-2 sm:mb-3">
            ...
            <div className="h-2 sm:h-3 bg-gray-100 rounded-full overflow-hidden relative">
          ...
          <div className="flex items-center justify-between pt-2 sm:pt-3 border-t border-gray-100 text-[10px] sm:text-xs">
