    ...
    <div className="flex items-center gap-2">
      ...
      >
        ...
        >
          {/* Front Side - Balance */}
          <div 
            className="px-6 py-3 bg-white border border-gray-200 rounded-telegram-lg hover:border-gray-300 transition-all shadow-md hover:shadow-lg"
            style={{
          ...
          {/* Back Side - Address */}
          <div 
            className="absolute top-0 left-0 w-full px-6 py-3 bg-white border border-gray-200 rounded-telegram-lg hover:border-gray-300 transition-all shadow-md hover:shadow-lg"
            style={{
              backfaceVisibility: 'hidden',
              WebkitBackfaceVisibility: 'hidden',
