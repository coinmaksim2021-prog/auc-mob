      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-4 mb-10">
          <button 
            ...
            className="bg-gray-900 text-white px-6 sm:px-10 py-3 sm:py-4 rounded-telegram-xl font-semibold text-sm sm:text-base hover:bg-black shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
          >
