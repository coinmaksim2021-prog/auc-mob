...
const LastChanceSection = ({ timeLeft, onPlaceBid }) => (
  <div className="mt-12 mb-12 py-12 text-center" data-testid="last-chance-section">
    ...
    <button 
      onClick={onPlaceBid}
      data-testid="last-chance-bid-btn"
      className="inline-flex items-center justify-center px-12 py-4 bg-gray-900 text-white text-lg font-semibold rounded-3xl hover:bg-black transition-all shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
    >
      Place Bid
    </button>
  </div>
