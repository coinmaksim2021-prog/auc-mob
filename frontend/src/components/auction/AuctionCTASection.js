  ...
  return (
    <section className="bg-gradient-to-b from-gray-50 to-white py-20 mt-12">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-gray-900 mb-6">Don't Miss Your Chance</h2>
        <p className="text-lg text-gray-600 mb-8">
          Secure your spot in the FOMO NFT collection and unlock exclusive rewards
        </p>
        <div className="flex items-center justify-center gap-4 mb-10">
          <button 
            onClick={scrollToPlaceBid}
            className="bg-gray-900 text-white px-10 py-4 rounded-3xl font-semibold text-base hover:bg-black shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
          >
            Place Bid Now →
          </button>
          <a
