                            ...
                            <label className="flex items-start gap-2.5 cursor-pointer group">
                              <div className="relative flex-shrink-0 mt-0.5">
                                <input
                                  ...
                                  className="peer sr-only"
                                />
                                <div className={`w-5 h-5 border-2 rounded-md transition-all duration-200 group-hover:border-emerald-400 shadow-sm flex items-center justify-center ${acceptedPrivacy ? 'border-emerald-500 bg-gradient-to-br from-emerald-400 to-teal-500' : 'border-gray-300'}`}>
                                  {acceptedPrivacy && (
                                    <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                                    </svg>
