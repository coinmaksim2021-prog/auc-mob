    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-teal-50 rounded-telegram-xl border border-emerald-100 mb-8 shadow-lg hover:shadow-xl transition-all">
      ...
      <div className="relative z-10 px-8 py-10">
        ...
        <div className="overflow-x-auto sm:overflow-visible -mx-4 px-4 sm:mx-0 sm:px-0">
          ...
          {/* NFTs Burned */}
          <div className="bg-white rounded-telegram-lg p-5 border border-gray-200 hover:border-orange-300 transition-all hover:shadow-lg transform hover:scale-105 active:scale-95 cursor-pointer">
            <div className="flex items-start justify-between mb-2">
              <span className="text-sm text-gray-600 font-medium flex items-center gap-1">
                NFTs Burned
